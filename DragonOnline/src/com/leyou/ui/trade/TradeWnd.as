package com.leyou.ui.trade {
	...
	public class TradeWnd extends AutoWindow {
		 ...
		 * 对方的物品
		 */
		private var playItemArr:Vector.<Object>
		/**
		 * 自己的物品 记录index
		 */
		...
		private function init():void {
			...
			for (var i:int=0; i < 20; i++) {
				...
				if (i < 10) {
					render.y=(Math.ceil((i + 1) / 2) - 1) * 53;
					this.gridList.addToPane(render);
				} else {
					render.y=(Math.ceil((i - 10 + 1) / 2) - 1) * 53;
			...
			this.playItemArr=new Vector.<Object>;
		...
		private function onMouseOver(e:MouseEvent):void {
			if (this.visible && this.isshelves) {
				CursorManager.getInstance().updataCursor(CursorEnum.CURSOR_BACKPACKIN);
			}
		}
...
//			Core.me.checkRing("player/other/green.sif", selectPlay.infoB.id);
...
//			g.isLock=true;
		 ...
		 *
		 */
		public function serv_UpdatePlayerItem($info:Object):void {
