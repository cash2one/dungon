package com.leyou.ui.guild.child {
	...
	public class GuildSkillRender extends AutoSprite {
		...
		public function GuildSkillRender() {
			super(LibManager.getInstance().getXML("config/ui/guild/guildSkillRender.xml"));
			this.init();
