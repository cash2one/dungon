package com.leyou.ui.guildBattle.children
{
	...
	public class GuildBattleGuildMemRankRender extends Sprite
	{
		...
		public function GuildBattleGuildMemRankRender(){
			init();
		}
		...
		private function onDetailClick(item:GuildBattleMemItem):void{
			...
			if(flagArr[2] > 0){
				Cmd_GuildBattle.cm_UNZ_L(3, flagArr[1], flagArr[2]);
			}else{
				Cmd_GuildBattle.cm_UNZ_L(3, flagArr[1], flagArr[1]);
			}
		}
