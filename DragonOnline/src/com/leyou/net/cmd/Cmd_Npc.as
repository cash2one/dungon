...
* @param o
	   *
		...
		public static function sm_npc_C(o:Object):void {
			...
			UIManager.getInstance().taskCollectProgress.startProgress(o.t, function():void {
				var living:Living=UIManager.getInstance().gameScene.getLivingBase(o.stag) as Living;
				living && living.actOpen();
				Cmd_Npc.cmNpcCollect(o.npc);
			});
		}
