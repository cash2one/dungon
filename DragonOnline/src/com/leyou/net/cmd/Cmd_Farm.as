package com.leyou.net.cmd
{
	...
	public class Cmd_Farm
	{
		 ...
		 * 
		 */
		public static function cm_FAM_F():void{
			NetGate.getInstance().send(CmdEnum.CM_FAM_F);
		}
		 ...
		 * 
		 */
		public static function cm_FAM_S(landId:int):void{
			NetGate.getInstance().send(CmdEnum.CM_FAM_S+","+landId);
		}
		...
		public static function sm_FAM_UT(obj:Object):void{
			...
			var fc1:String = "神树灌溉<font color='#ff00'><u><a href='event:other_farm--farm'>{1}</a></u></font>";
			var fc2:String = "领取宝箱<font color='#ff00'><u><a href='event:other_farm--farm'>{1}</a></u></font>";
			var fc3:String = "作物收获<font color='#ff00'><u><a href='event:other_farm--farm'>{1}</a></u></font>";
			// 0--可种植 1--成长中 2--可收获
			if(0 == rt){
				fc3 = StringUtil.substitute(fc3, "可种植");
			}else if(1 == rt){
				fc3 = StringUtil.substitute(fc3, "成长中");
			}else{
				fc3 = StringUtil.substitute(fc3, "可收获");
			}
			if(2 == status){
				fc1 = StringUtil.substitute(fc2, "点击领取");
			}else if(1 == status){
				fc1 = StringUtil.substitute(fc1, "可灌溉");
			}else{
				fc1 = StringUtil.substitute(fc1, "冷却中");
			}
			var arr:Array = ["[农场]", fc1, fc3, "", callBack];
