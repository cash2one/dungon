...
//						}
						...
						if (data[1] == 1){
							str+=" 损失<font color='#ff0000'>" + data[2] + "</font>积分,";
						}else{
							str+=" 获得<font color='#00ff00'>" + data[2] + "</font>积分,";
						}
...
//						this.ctxLbl.htmlText=str + "";
					...
					case NoticeEnum.ICON_LINK_FRIEND:
						var content:String = "{1}已经添加你为好友，是否添加他为好友？";
					...
					case NoticeEnum.ICON_LINK_THOUGHT:
						...
						PopupManager.showAlert(tc, null, false, "notice.thought", "打坐提醒");
						break;
