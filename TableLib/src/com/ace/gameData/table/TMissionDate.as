package com.ace.gameData.table
{
	...
	public class TMissionDate
	{
		 ...
		 *	travel_point
		 */
		public var travel_point:int;
		
		/**
		 *	完成指定数量的日常任务
		 *	
		 */
		public var N_OBJ_Num:int;
		
		/**
		 *	参与指定次数的竞技场
		 *	
		 */
		public var NJJC_Num:int;
		
		/**
		 *	开启指定数量的纹章节点
		 *	
		 */
		public var Y_Blood_Num:int;
		
		/**
		 *	坐骑进阶到指定等阶
		 *	
		 */
		public var Y_Mount_lv:int;
		
		/**
		 *	通关指定剧情副本
		 *	
		 */
		public var Y_Dungeon_ID:int;
		
		/**
		 *	提升任意装备强化等级数
		 *	
		 */
		public var Y_ST_lv:int;
		
		/**
		 *	进行指定次数的元素经验抽取
		 *	
		 */
		public var Y_Ele_Time:int;
