package com.ace.gameData.table {
	...
	public class TPayPromotion {
		...
		public var day_end:int;
		public var day_view:int;

		public var Rp_title:int;
		...
		public function TPayPromotion(xml:XML) {
			...
			type2=xml.@type2;
			btn_des=xml.@btn_des;
			position=xml.@Rp_Position;
			des1=xml.@Re_script1;
			des2=xml.@Re_script2;
			des3=xml.@Re_script3;
			des4=xml.@Re_script4;
			btnUrl=xml.@btn;
			Rp_title=xml.@Rp_title;
			showType=xml.@type;
			mail=xml.@mail;
			rp_time=xml.@RE_view;
...
//			} else if (this.position.indexOf(":") > -1) {
