package com.ace.enum {
	...
	public class EventEnum {
		//面板打开
		static public const WINDOW_SHOW:String="windowShow";

		//任务改变
		static public const TASK_CHANGE:String="taskChange";
		...
		static public const SCENE_WEATHER_START:String="startWeather"; //场景天气
		static public const SCENE_WEATHER_STOP:String="stopWeather"; //场景天气
