		...
		protected function onButtonClick(event:MouseEvent):void{
			...
			switch(n){
				case "levelUpBtn":
					...
					if(null != nextLvInfo){
						content = com.ace.utils.StringUtil.substitute(content, farmLvInfo.cost, nextLvInfo.level, nextLvInfo.profitRate);
...
//						PopWindow.showWnd(UIEnum.WND_TYPE_CONFIRM, w, "wind.confirm.blockLevelUp");
				...
				case "refreshBtn":
					...
					if(ert <= 0){
						...
						PopupManager.showConfirm(c, Cmd_Farm.cm_FAM_F, null, false, "farm.shop.refresh");
					}
					break;
			}
		}
