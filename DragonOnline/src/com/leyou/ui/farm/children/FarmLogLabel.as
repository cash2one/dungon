package com.leyou.ui.farm.children
{
	...
	{
		private static const getLogTpl:String = "<Font face='SimSun' size='12' color='#69e053'>【抢收】</Font>{1}您收取了" +
			"<Font face='SimSun' size='12' color='#ffd700'>{2}</Font>" +
			"<Font face='SimSun' size='12' color='#ffd700'>{3}</Font>中的" +
			"<Font face='SimSun' size='12' color='#ffd700'>{4}</Font>"
		private static const loseLogTpl:String = "<Font face='SimSun' size='12' color='#ff0000'>【被抢】</Font>{1}" +
			"<Font face='SimSun' size='12' color='#ffd700'>{2}</Font>抢收了你" +
			"<Font face='SimSun' size='12' color='#ffd700'>{3}</Font>的" +
			"<Font face='SimSun' size='12' color='#ffd700'>{4}</Font>";
		...
		public function updataInfo(data:Array):void{
			...
			var copeCount:String  = data[5] + pinfo.getEarnName();
