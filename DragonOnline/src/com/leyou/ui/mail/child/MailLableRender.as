...
//				fromLbl.text = mailInfo.sourceName;
				...
				dataLbl.text=(date.month + 1) + PropUtils.getStringById(1782) + date.date + PropUtils.getStringById(1665);
				...
				if (day > 0) {
					surplusLbl.text=day + PropUtils.getStringById(1783);
				} else if (hours > 0) {
					surplusLbl.text=hours + PropUtils.getStringById(1706);
				} else {
					surplusLbl.text=minute + PropUtils.getStringById(2147);
				}
...
//				fromLbl.text = mailInfo.sourceName;
				...
				var hours:int=remain / 60 / 60;
				var day:int=hours / 24;
				surplusLbl.text=(day > 0) ? (day + PropUtils.getStringById(1783)) : (hours + PropUtils.getStringById(1706));
				var hasStuff:Boolean=false;
				var stuffList:Object=mailInfo.stuffList;
				for (var key:String in stuffList) {
					hasStuff=true;
