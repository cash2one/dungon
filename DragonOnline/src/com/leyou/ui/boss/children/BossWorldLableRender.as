	...
	public class BossWorldLableRender extends AutoSprite {
		...
		protected function onMouseClick(event:MouseEvent):void {
			...
			switch (event.target.name) {
				case "flyBtn":
					if (ConfigEnum.FieldBossForbiddenLeve <= (Core.me.info.level - bossInfo.openLv-5)) {
				...
				case "refreshCheck":
					...
					DataManager.getInstance().fieldBossData.setRemind(_bossId);
					break;
			}
		}

		public function onFlyBtn(type:int):void {
