...
//			nmagicDefLbl = getUIbyID("nmagicDefLbl") as Label;
			...
			nbloodTLbl = getUIbyID("nbloodTLbl") as Label;
			...
			nguardTLbl = getUIbyID("nguardTLbl") as Label;
			
			var table:TableManager = TableManager.getInstance();
			hpTLbl.text = table.getAttributeInfo(1).attibuteDes;
			nbloodTLbl.text = table.getAttributeInfo(1).attibuteDes;
			attTLbl.text = table.getAttributeInfo(4).attibuteDes;
			nattTLbl.text = table.getAttributeInfo(4).attibuteDes;
			defTLbl.text = table.getAttributeInfo(5).attibuteDes;
			ndefTLbl.text = table.getAttributeInfo(5).attibuteDes;
			critTLbl.text = table.getAttributeInfo(8).attibuteDes;
			ncritTLbl.text = table.getAttributeInfo(8).attibuteDes;
			tenacityTLbl.text = table.getAttributeInfo(9).attibuteDes;
			ntenacityTLbl.text = table.getAttributeInfo(9).attibuteDes;
			hitTLbl.text = table.getAttributeInfo(10).attibuteDes;
			nhitTLbl.text = table.getAttributeInfo(10).attibuteDes;
			dodgeTLbl.text = table.getAttributeInfo(11).attibuteDes;
			ndodgeTLbl.text = table.getAttributeInfo(11).attibuteDes;
			slayTLbl.text = table.getAttributeInfo(12).attibuteDes;
			nslayTLbl.text = table.getAttributeInfo(12).attibuteDes;
			guardTLbl.text = table.getAttributeInfo(13).attibuteDes;
			nguardTLbl.text = table.getAttributeInfo(13).attibuteDes;
		}
