package com.leyou.ui.promotion.children {
	...
	public class PromotionHourseRender extends AutoSprite {
		...
		public function PromotionHourseRender() {
			super(LibManager.getInstance().getXML("config/ui/promotion/wybqHorseRender.xml"));
			init();
		}
		...
		public function updateInfo(data:PayPromotionItem):void {
			...
			nameImg.updateBmp("ui/horse/horse_lv" + tinfo.value + "_name.png");
