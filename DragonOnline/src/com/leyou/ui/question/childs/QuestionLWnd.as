package com.leyou.ui.question.childs {
	...
	public class QuestionLWnd extends AutoSprite {

		private var rimg:Image;
		private var contentBtn:QuestionBtn;

		public function QuestionLWnd() {
			super(LibManager.getInstance().getXML("config/ui/question/questionLWnd.xml"));
			this.init();
		...
		private function init():void {
			...
			this.addChild(this.getUIbyID("riImg"));

			this.contentBtn.x=130;
		...
		private function onClick(e:MouseEvent):void {
			...
			var info:TPointInfo=TableManager.getInstance().getPointInfo(ConfigEnum.question10);
