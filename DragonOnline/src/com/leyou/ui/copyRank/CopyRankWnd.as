package com.leyou.ui.copyRank {
	...
	public class CopyRankWnd extends AutoWindow {
		...
		public function setTabIndex(i:int):void {
			...
			switch (i) {
				case 1:
					this.storyBtn.dispatchEvent(new MouseEvent(MouseEvent.CLICK));
					break;
				case 2:
					this.bossBtn.dispatchEvent(new MouseEvent(MouseEvent.CLICK));
					break;
				case 3:
					this.towerBtn.dispatchEvent(new MouseEvent(MouseEvent.CLICK));
					break;
			}
