package com.leyou.ui.task.child {
	...
	public class MissionTrackLable extends AutoSprite {
		...
		public function MissionTrackLable() {
			super(LibManager.getInstance().getXML("config/ui/task/missionTrackLable.xml"));
			this.init();
...
//			this.taskTargetLbl.x=200;
		}


		public function updateInfo(o:Array):void {
			this.taskTypeLbl.htmlText=o[0] + "";
			this.taskNameLbl.htmlText=o[1] + "";
			this.taskTargetLbl.htmlText=o[2] + "";
		}
