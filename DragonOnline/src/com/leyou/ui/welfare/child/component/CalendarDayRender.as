package com.leyou.ui.welfare.child.component {
	...
	public class CalendarDayRender extends Sprite {
		...
		private static const Format:TextFormat=new TextFormat(null, 18, 0xffffff, true, null, null, null, null, TextFormatAlign.CENTER)
		// 底图
...
//					PopupManager.showAlert(content, onOKClick, false, "calender.sign");
					...
					NoticeManager.getInstance().broadcastById(10171);
				}
			}
		}
