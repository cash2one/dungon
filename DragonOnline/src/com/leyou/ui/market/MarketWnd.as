...
//			marketDTab = getUIbyID("marketTabBar") as TabBar;
			...
			effswf=getUIbyID("effswf") as SwfLoader;
...
//			marketDTab.turnToTab(0);
			...
			adWnd.y=75;
			pane.addChild(adWnd);
			pane.swapChildren(adWnd, payBtn);

			this.addChild(effswf);
			...
			promotionRender.x=62;
			promotionRender.y=290;
...
//			}
			...
			if (Core.isTencent && (0 == _currentIdx)) {
				showTencentMarket();
				return;
			}
