...
//			}
			...
			switch(name){
				...
				case "accelerateBtn":
					...
					if(FarmEnum.TREE_RIPE_CD == treeStatus){
						value = ConfigEnum.FarmCatalyticBoxCDCost;
					}else if(FarmEnum.TREE_WATER_CD == treeStatus){
						value = ConfigEnum.FarmCatalyticCDCost;
					}
					content = StringUtil.substitute(content, value);
					PopupManager.showConfirm(content, treeAccelerate, null, false, "farm.tree.accelerate");
					break;
			}
		}
		 ...
		 * 
		 */		
		public function treeAccelerate():void{
			Cmd_Farm.cm_FAM_S(0);
		}
